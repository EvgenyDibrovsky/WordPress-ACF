            ...
            languages: {
                pl: {
                    ...
                    settings_modal: {
                        ...
                        cookie_table_headers: [{ col1: 'Nazwa' }, { col2: 'Domena' }, { col3: 'Wygaśnięcie' }, { col4: 'Opis' }],
                        blocks: [
                            {
                            ...
                            },
                            {
                                ...
                                cookie_table: [
                                    // list of all expected cookies
                                    {
                                        ...
                                        col2: 'google.com',
                                        col3: '2 lata',
                                        col4: 'Służy do rozróżniania użytkowników i utrzymywania stanu sesji.',
                                        is_regex: true,
                                    },
                                ],
                            },
                                ...
                                cookie_table: [
                                    {
                                        ...
                                        col2: 'google.com',
                                        col3: '3 miesiące',
                                        col4: 'Służy do przechowywania i śledzenia konwersji.',
                                        is_regex: true,
                                    },
                                    {
                                        col1: 'IDE',
                                        col2: 'google.com',
                                        col3: '1 rok',
                                        col4: 'Służy do zapewnienia dostarczania reklam lub retargetingu.',
                                        is_regex: true,
                                    },
                                ],
                            },
